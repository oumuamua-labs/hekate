...
use hekate_gadgets::chiplets::pqc::basemul::{
    generate_basemul_trace, BasemulChiplet, BasemulOp, CpuBasemulColumns, CpuBasemulUnit,
};
...
fn adversarial_corrupted_sum_rejected() {
    ...
    let bm_layout = hekate_gadgets::chiplets::pqc::basemul::BasemulLayout::compute(12);
