...
use hekate_gadgets::chiplets::pqc::ntt::{
    generate_ntt_trace, NttButterfly, NttChiplet, NttFlowCompanion, NttMulOnly, NttOp,
};
use hekate_gadgets::chiplets::pqc::twiddle_rom::{
    generate_twiddle_rom_trace, TwiddleEntry, TwiddleRomChiplet, TWIDDLE_W_BINDING_BUS_ID,
};
...
use zk_scribble::{assert_all_caught_all_targets, MutationKind, ScribbleConfig};
...
fn exploit_corrupted_a_out() {
    ...
    let layout = hekate_gadgets::chiplets::pqc::ntt::NttLayout::compute(Q, 12);
